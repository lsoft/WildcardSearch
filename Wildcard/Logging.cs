...
namespace Wildcard
{
    ...
    public static class Logging
    {
        ...
        // Logs go to: C:\Users\<user>\AppData\Local\Temp\wildcardvsix_extension.log
        // We're using one log file for each process to prevent concurrent file access.
        private static readonly string vsLogFile = $"{Path.GetTempPath()}/wildcardvsix_extension.log";
